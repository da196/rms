    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
              ...
              <div class="ibox-tools">   
                   <select name="reporter_id" id="reporter_id" style="width: 100%">
            ...
            <div class="ibox-content">
                <div class="table-responsive">   
                     <table id="keyriskindicators_data_report" class="table table-bordered table-striped" style="width:100%">  
                        <thead>  
                           <tr>  
                              <th width="">S/N</th>    
                              <!-- <th width="10%">Directorate</th>   -->
                              <th width="">Risk Owner</th>                               
                              <th width="">Strategic Objective</th>
           ...
           <form method="post" id="keyriskindicators_form">  
                <div class="modal-content">  
                     ...
                     <div class="modal-body">  
                          ...
                          <input type="text" name="risk_owner" id="risk_owner" class="form-control" placeholder="Enter a risk owner ..." required/> 
                          <br />  
                          <label>Strategic Objective</label><span class="asterisk">*</span> 
                          <select class="form-control" name="objective_id" id="objective_id" style="width: 100%" required>
                            <option value=""> -- Select -- </option>
                            <?php foreach($strategicobjectives as $strategicobjective):?>
                               <option value="<?php echo $strategicobjective->id; ?>"><?php echo $strategicobjective->name; ?></option>
                            <?php endforeach;?>
                          </select>
                          <br />  
                          ...
                          <br /> 
                          <label>Key Risk Indicator Descriptions</label><span class="asterisk">*</span>  
                          <textarea class="form-control" name="description" id="description" placeholder="Enter Descriptions ..." required rows="5"></textarea>
                          <br /> 
                         ...
                         <div class="row">
                           <div class="col-md-12">
                             ...
                             <div class="col-md-4">
                               <label style="color:#ffbf00;">Amber</label>
        ...
        <div class="modal-content animated fadeIn">
            ...
            <div class="modal-body"> 
              <form id="keyriskindicators_form_viewonly">
                ...
                <div class="row">
                     <div class="col-md-12">
                          <label>Key Risk Indicator Descriptions</label>  
