...
$(document).ready(function(){  
    ...
    var counterA = 1;
        ...
        var newTextBoxDivA = $(document.createElement('div'))
                ...
                newTextBoxDivA.after().html('<div class="col-sm-11"> <textarea class="form-control" placeholder="Cause ..."  name="causes_textBoxs" '+	                                           
                                        ...
                                        '<div class="col-sm-1"><button name="remove" id="textbox' +counterA+ '" class="col-2 btn btn-xs btn-danger btn-remove-causes"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
        ...
        if(counterReason <= maxFields){ 
            var newTextBoxDivP = $(document.createElement('div'))
                                ...
                                newTextBoxDivP.after().html('<div class="col-sm-11"> <textarea class="form-control" placeholder="Cause reason ..."  name="causesReason_textBoxs" '+	                                           
                                            ...
                                            '<div class="col-sm-1"><button name="remove" id="textbox' +counterReason+ '" class="col-2 btn btn-xs btn-danger btn-remove-causes-reason"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
    ...
    $("#addEvents").click(function(e){
        var newTextBoxDivB = $(document.createElement('div')).attr("id", 'TextBoxDiv2' + counterB);
        newTextBoxDivB.after().html('<div class="col-sm-11"><textarea class="form-control" placeholder="Event ..." name="events_textBoxs" '+	                                           
                                        ...
                                        '<div class="col-sm-1"><button name="remove" id="textbox' +counterB+ '" class="col-2 btn btn-xs btn-danger btn-remove-events"><i class="fa fa-trash"></i>&nbsp;Remove</button></div>');                                           
        ...
        if(counterReasons <= maxFields){ 
            var newTextBoxDivW = $(document.createElement('div'))
                    ...
                    newTextBoxDivW.after().html('<div class="col-sm-11"><textarea class="form-control" placeholder="Event reason ..."  name="eventsReason_textBoxs" '+	                                           
                                            ...
                                            '<div class="col-sm-1"><button name="remove" id="textbox' +counterReasons+ '" class="col-2 btn btn-xs btn-danger btn-remove-events-reason"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
    ...
    $("#addConsequences").click(function(e){
        var newTextBoxDivC = $(document.createElement('div'))
                ...
                newTextBoxDivC.after().html('<div class="col-sm-11"><textarea class="form-control" placeholder="Consequences ..." name="cons_textBoxs" '+	                                           
                                        ...
                                        '<div class="col-sm-1"><button name="remove" id="textbox' +counterC+ '" class="col-2 btn btn-xs btn-danger btn-remove-consequences"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
        ...
        if(counterReasonTo <= maxFieldsTo){ 
            var newTextBoxDivTo = $(document.createElement('div'))
                    ...
                    newTextBoxDivTo.after().html('<div class="col-sm-11"> <textarea class="form-control" placeholder="Consequence reason ..."  name="consReason_textBoxs" '+	                                           
                                            ...
                                            '<div class="col-sm-1"><button name="remove" id="textbox' +counterReasonTo+ '" class="col-2 btn btn-xs btn-danger btn-remove-consequences-reason"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
   ...
   // REMOVE BUTTON IN CONSEQUENCES
    ...
    $("#addExControls").click(function(e){
        var newTextBoxDivD = $(document.createElement('div'))
                ...
                newTextBoxDivD.after().html('<div class="col-sm-11"><textarea class="form-control" placeholder="Existing controls ..." name="Excontrols_textBoxs" '+	                                           
                                        '" id="textbox' +counterD+'_"></textarea></div>'+
                                        '<div class="col-sm-1"><button name="remove" id="textbox' +counterD+ '" class="col-2 btn btn-xs btn-danger btn-remove-ExControls"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
   ...
   // REMOVE BUTTON IN EXISTING CONTROLS
    ...
    $("#addADControls").click(function(e){
        var newTextBoxDivE = $(document.createElement('div'))
                ...
                newTextBoxDivE.after().html('<div class="col-sm-11"><textarea class="form-control" placeholder="Additional controls ..." name="adControls_textBoxs" '+	                                           
                                        '" id="textbox' +counterE+'_"></textarea></div>'+
                                        '<div class="col-sm-1"><button name="remove" id="textbox' +counterE+ '" class="col-2 btn btn-xs btn-danger btn-remove-consequences"><i class="fa fa-trash"></i>&nbsp;Remove</button></div></br>');                                              
   ...
   // REMOVE BUTTON IN ADDITIONAL CONTROLS
    ...
    $('#edit_risk_register_btn').click(function(){
        var causes = [];     
        var causes_reason = [];     
        var events = [];    
        var events_reason = [];             
        ...
        var createdAtFromDB = $('#createdAtFromDB').val(); 
        var createdByFromDB = $('#createdByFromDB').val(); 
       ...
       // alert(events); alert(events_reason);

       $.ajax({
            url:"<?php echo base_url();?>registry/risk_register_update",
            method:"POST",
            data:{

                createdAtFromDB:createdAtFromDB,
                createdByFromDB:createdByFromDB,
            ...
            success:function(msg){
                ...
                if(test.Status_code == 404){ 
                    ...
                    function(){ 
                        ...
                        window.location = "<?php echo base_url(); ?>registry/risk_register_edit_page/"+registry_id;
                    });
                }
                else{                                                       
                    swal(" ", test.Message, "error"); 
            ...
            error:function(){
                swal({title:"",text:"Failed to edit risk register ...!", type: "error"},
                    function(){ 
    ...
    $('.delete_cause').click(function(event){
        ...
        swal({
            ...
            window.location = "<?php echo base_url(); ?>registry/delete_risk_register_causes/"+id+"/"+reg_id+"/"+inputValue; 
    ...
    $('.delete_event').click(function(event){
        ...
        swal({
            ...
            window.location = "<?php echo base_url(); ?>registry/delete_risk_register_events/"+id+"/"+reg_id+"/"+inputValue; 
    ...
    $('.delete_consequence').click(function(event){
        ...
        swal({
                ...
                window.location = "<?php echo base_url(); ?>registry/delete_risk_register_consequences/"+id+"/"+reg_id+"/"+inputValue; 
    ...
    $('.delete_excontrol').click(function(event){
        ...
        if(confirm(" Do you want to delete this Registry Existing Control ? ")){
            window.location = "<?php echo base_url(); ?>registry/delete_risk_register_excontrols/"+id+"/"+reg_id;
        }else{
            window.location.reload(); 
        }
    });
    ...
    $('.delete_adcontrol').click(function(event){
        ...
        if(confirm(" Do you want to delete this Registry Additional Control ? ")){
            window.location = "<?php echo base_url(); ?>registry/delete_risk_register_adcontrols/"+id+"/"+reg_id;
        }else{
            window.location.reload(); 
        }
    });
