        ...
        <div class="ibox float-e-margins">
        	...
        	<div class="ibox-title">
                ...
                <div class="ibox-tools">   
                    <!-- KRI CREATE BUTTON -->
                    <button type="button" class="btn btn-success" id="add_button_keyriskindicators" data-toggle="modal" data-target="#keyriskindicatorsModal"><i class="fa fa-plus"></i>&nbsp;Create</button>               
                </div>                 
            </div>
           ...
           <form method="post" id="keyriskindicators_form">  
                <div class="modal-content">  
                     ...
                     <div class="modal-body">  
                          ...
                          <select class="form-control" name="risk_owner" id="risk_owner" required>
                            <option value=""> -- Select -- </option>
                          ...
                          <br />  
                          <label>Organization Objective</label><span class="asterisk">*</span> 
            ...
            <div class="modal-body"> 
              <form id="keyriskindicators_form_viewonly">
               <!--  <div class="row">                  
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label>Organization Objective</label>   
