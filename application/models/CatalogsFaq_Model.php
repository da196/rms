<?php  
 class CatalogsFaq_Model extends CI_Model  
 {  
    var $table = "erms_faq"; 
    //table Columns
    var $column_id = "id";
    var $column_faq_question = "faq_question";
    var $column_faq_answer = "faq_answer";
    var $column_active = "active"; 

    var $select_column = array("id", "faq_question", "faq_answer", "active");  
    var $order_column = array(null, "faq_question", "faq_answer",  "active", null);// Null on index ....
    //order on display page... id,faq_question,faq_answer, active, action --- 0,1,2,3,4,5
    ...
    {  
       ...
       {  
          ...
          $this->db->or_like($this->column_faq_answer, $_POST["search"]["value"]);          
