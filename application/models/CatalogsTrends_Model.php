<?php  
 class CatalogsTrends_Model extends CI_Model  
 {  
    var $table = "erms_trends"; 
    //table Columns
    var $column_id = "id";
    var $column_trend_name = "trend_name";
    var $column_color_code = "color_code";
    var $column_active = "active"; 

    var $select_column = array("id", "trend_name", "color_code");  
    var $order_column = array(null, "trend_name", null);// Null on index ....
    ...
    {  
       ...
       {  
          ...
          $this->db->or_like($this->column_trend_name, $_POST["search"]["value"]);          
