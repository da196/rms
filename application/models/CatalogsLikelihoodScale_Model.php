<?php  
 class CatalogsLikelihoodScale_Model extends CI_Model  
 {  
    var $table = "erms_like_hood_scale"; 
    //table Columns
    var $column_id = "id";
    var $column_like_hood_scale = "like_hood_scale";
    var $column_like_hood_scale_score = "like_hood_scale_score";
    var $column_color_code = "color_code";
    var $column_active = "active"; 

    var $select_column = array("id", "like_hood_scale", "like_hood_scale_score", "color_code");  
    var $order_column = array(null, "like_hood_scale", "like_hood_scale_score",  "color_code", null);// Null on index ....
    ...
    {  
       ...
       {  
          ...
          $this->db->or_like($this->column_like_hood_scale, $_POST["search"]["value"]);          
