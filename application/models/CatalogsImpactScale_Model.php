<?php  
 class CatalogsImpactScale_Model extends CI_Model  
 {  
    var $table = "erms_impact_scale"; 
    //table Columns
    var $column_id = "id";
    var $column_impact_scale = "impact_scale";
    var $column_impact_scale_score = "impact_scale_score";
    var $column_color_code = "color_code";
    var $column_active = "active"; 

    var $select_column = array("id", "impact_scale", "impact_scale_score", "color_code");  
    var $order_column = array(null, "impact_scale", "impact_scale_score","color_code", null);// Null on index ....
    ...
    {  
       ...
       {  
          ...
          $this->db->or_like($this->column_impact_scale, $_POST["search"]["value"]);          
