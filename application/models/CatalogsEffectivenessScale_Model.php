<?php  
 class CatalogsEffectivenessScale_Model extends CI_Model  
 {  
    var $table = "erms_controls_effectiveness_scale"; 
    //table Columns
    var $column_id = "id";
    var $column_controls_effectiveness_scale = "controls_effectiveness_scale";
    var $column_controls_effectiveness_scale_score = "controls_effectiveness_scale_score";
    var $column_color_code = "color_code";
    var $column_active = "active"; 

    var $select_column = array("id", "controls_effectiveness_scale", "controls_effectiveness_scale_score","color_code");  
    var $order_column = array(null, "controls_effectiveness_scale", "controls_effectiveness_scale_score","color_code", null);// Null on index ....
    ...
    {  
       ...
       {  
          ...
          $this->db->or_like($this->column_controls_effectiveness_scale, $_POST["search"]["value"]);          
